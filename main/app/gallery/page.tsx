                ...
                >
                  <CardContent className="p-0 flex-grow space-y-10">
                    ...
                    <div className="flex flex-col items-center justify-center space-y-10 align-baseline bottom-0">
                      ...
                      <Button
                        className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 w-[50%] text-lg font-bold font-indie"
